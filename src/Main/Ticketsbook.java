 ...
 * @author ph2tn
 */
public class Ticketsbook extends BaseFrame {

    /**
     * Creates new form Ticketsbook
     */
    public Ticketsbook() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ticketsbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ticketsbook().setVisible(true);
            }
        });
    }
